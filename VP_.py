...
if not filtered_df.empty:
    display_columns = ["Менеджер","Код","ИНН", "Покупатель","ОП", "ОП План", "% ОП", "ВП", "ВП План", "% ВП", "ОП_ПГ"]#"Менеджер", "Покупатель"] # , ,"Добавить в план","Регион","Отдел","Канал"
    ...
    st.subheader("📋 Результаты на 16.06.2025")
